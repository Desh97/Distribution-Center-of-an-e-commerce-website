    ...
    (
      ...
      this.section6 = [ ];
        ...
        for (let x1 = 0;x1<this.maps.length ; x1++){
          const obj = {name:this.maps[x1],type:"",shelfA:"",shelfB:"",shelfC:"",shelfASup:"",shelfBSup:"",shelfCSup:"",workerList:[{workerName:""},{workerName:""}]};
        ...
        this.section1[this.section1.length-1].type="Packaging Area"
        this.section2[this.section2.length-1].type="Packaging Area"
        this.section3[this.section3.length-1].type="Packaging Area"
        this.section4[this.section4.length-1].type="Packaging Area"
        this.section5[this.section5.length-1].type="Packaging Area"
        this.section6[this.section6.length-1].type="Packaging Area"
      },
                ...
                if(this.section1[s1].name == obj.location.substring(0,4)){
                  ...
                  switch(shelfLetter) {
                    case 'A': {
                      ...
                      this.section1[s1].type = "itemShelf";
                      break;
                    }
                    case 'B': {
                ...
                if(this.section2[s2].name == obj.location.substring(0,4)){
                  ...
                  switch(shelfLetter) {
                    case 'A': {
                      ...
                      this.section2[s2].type = "itemShelf";
                      break;
                    }
                    case 'B': {
                ...
                if(this.section3[s3].name == obj.location.substring(0,4)){
                  ...
                  switch(shelfLetter) {
                    case 'A': {
                      ...
                      this.section3[s3].type = "itemShelf";
                      break;
                    }
                    case 'B': {
                ...
                if(this.section4[s4].name == obj.location.substring(0,4)){
                  ...
                  switch(shelfLetter) {
                    case 'A': {
                      ...
                      this.section4[s4].type = "itemShelf";
                      break;
                    }
                    case 'B': {
                ...
                if(this.section5[s5].name == obj.location.substring(0,4)){
                  ...
                  switch(shelfLetter) {
                    case 'A': {
                      ...
                      this.section5[s5].type = "itemShelf";
                      break;
                    }
                    case 'B': {
                ...
                if(this.section6[s6].name == obj.location.substring(0,4)){
                  ...
                  switch(shelfLetter) {
                    case 'A': {
                      ...
                      this.section6[s6].type = "itemShelf";
                      break;
                    }
                    case 'B': {
